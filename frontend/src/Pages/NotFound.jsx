...
const NotFound = () => {
    return (
        <section className='section-wrap flex min-h-[78vh] items-center justify-center py-10'>
            ...
            <div className='relative w-full max-w-3xl overflow-hidden rounded-none border border-[var(--line)] bg-[var(--surface)] p-8 text-center _24px_80px_rgba(0,0,0,0.16)] md:p-12'>
                <div className='pointer-events-none absolute -left-10 -top-10 h-40 w-40 rounded-none bg-[var(--accent)]/18 blur-3xl' />
                <div className='pointer-events-none absolute -right-10 bottom-0 h-40 w-40 rounded-none bg-[var(--accent-2)]/18 blur-3xl' />
                ...
                <div className='relative'>
                    ...
                    <div className='mt-8 flex flex-wrap items-center justify-center gap-3'>
                        <Link to='/' className='inline-flex items-center gap-2 rounded-none bg-[var(--ink)] px-5 py-3 text-sm font-semibold text-[var(--bg)] transition hover:-translate-y-0.5 hover:opacity-90'>
