...
const ContactProfile = ({ contact, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-gray-900/50 backdrop-blur-sm transition-opacity">
      <div className="w-full max-w-xl bg-white dark:bg-gray-900 h-full  overflow-y-auto animate-slide-in-right">
        {/* Header */}
        <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800">
          ...
          <button onClick={onClose} className="p-2 rounded-none hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-500 transition-colors">
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6">
          <div className="flex items-center space-x-5 mb-8">
            <div className="w-20 h-20 rounded-none bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white text-3xl font-bold ">
            ...
            <div>
              ...
              <div className="flex items-center mt-3 space-x-2">
                ...
                <span className="px-3 py-1 rounded-none text-xs font-semibold bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400">
                  {contact.status || 'NEW'}
                </span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="p-4 rounded-none bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50">
            ...
            {contact.companyId && (
              <div className="p-4 rounded-none bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 md:col-span-2">
          ...
          {contact.message && (
            <div className="mb-8">
              ...
              <div className="p-4 rounded-none bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700/50 text-gray-700 dark:text-gray-300 whitespace-pre-wrap text-sm">
                {contact.message}
              </div>
            </div>
          )}
            ...
            <div className="mb-8">
              ...
              <div className="flex space-x-3">
                {contact.socialLinks.linkedin && (
                  <a href={contact.socialLinks.linkedin} target="_blank" rel="noreferrer" className="p-2 rounded-none bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors">
                    <Linkedin className="w-5 h-5" />
                  </a>
                )}
                {contact.socialLinks.twitter && (
                  <a href={contact.socialLinks.twitter} target="_blank" rel="noreferrer" className="p-2 rounded-none bg-blue-50 text-blue-400 hover:bg-blue-100 transition-colors">
                    <Twitter className="w-5 h-5" />
                  </a>
                )}
                {contact.socialLinks.github && (
                  <a href={contact.socialLinks.github} target="_blank" rel="noreferrer" className="p-2 rounded-none bg-gray-100 text-gray-900 hover:bg-gray-200 transition-colors dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
