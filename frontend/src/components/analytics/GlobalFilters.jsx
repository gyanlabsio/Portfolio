...
const GlobalFilters = () => {
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-none p-4  border border-gray-100 dark:border-gray-700 mb-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-3">
          <div>
            ...
            <input 
              type="date" 
              className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-none focus:ring-blue-500 focus:border-blue-500 block w-full p-2"
