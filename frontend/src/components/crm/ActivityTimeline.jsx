        ...
        <div className="space-y-6 border-l-2 border-gray-100 dark:border-gray-800 ml-3">
          {activities.map((activity, index) => (
            <div key={index} className="relative pl-6">
              <div className="absolute -left-2 top-1.5 w-4 h-4 rounded-none bg-blue-500 border-4 border-white dark:border-gray-900"></div>
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 p-3 rounded-none mt-2">
