    ...
    return (
        <div className='space-y-5'>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-4'>
                            ...
                            <div>
                                ...
                                <div className='rounded-none border border-dashed border-[var(--line)] bg-[var(--surface)] p-4'>
                                    ...
                                    {form.coverImage && <img src={form.coverImage} alt='preview' className='mt-4 h-32 w-full max-w-[200px] rounded-none border border-[var(--line)] object-cover' />}
                                </div>
                            </div>
            ...
            {loading ? (
                ...
                <p className=' rounded-none py-16 text-center text-[var(--ink-soft)]'>No projects yet. Create your first one!</p>
            ) : (
                <div className='space-y-3'>
                    {projects.map((p) => (
                        <div key={p._id} className=' flex items-center justify-between gap-4 rounded-none p-4'>
                            <div className='flex items-center gap-4 flex-1 min-w-0'>
                                {p.coverImage && <img src={p.coverImage} alt='' className='h-12 w-16 shrink-0 rounded-none border border-[var(--line)] object-cover' />}
